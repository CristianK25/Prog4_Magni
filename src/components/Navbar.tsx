...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-white shadow-sm mb-4 sticky top-0 z-50">
      ...
      {/* Menú Desplegable (Hamburguesa funcional) */}
      <div className={`overflow-hidden transition-all duration-300 bg-green-600 ${isOpen ? "max-h-40 opacity-100" : "max-h-0 opacity-0"}`}>
      ...
      {/* Barra de Estadísticas (Sub-navbar) */}
